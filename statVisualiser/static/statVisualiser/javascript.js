    ...
    if (name !== '') {
        ...
        for (let i = 0; i < list.length; i++) {
            for (let j = 0; j < labels.length; j++) {
                if (labels[j].htmlFor.includes('picker' + id + '-' + list[i]) || labels[j].htmlFor.includes('picker' + id + '-' + 'Output') || labels[j].htmlFor.includes('picker' + id + '-' + 'G_Min') || labels[j].htmlFor.includes('picker' + id + '-' + 'G_Max')) {
