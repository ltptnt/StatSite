...
class SampleDist(forms.Form):
    Type = forms.ModelChoiceField(label='Distribution', queryset=Distribution.objects.all(),
                                  required=False,
                                  empty_label='')
...
class NormalApproximation(forms.Form):
    min_trials = forms.IntegerField(initial=10, required=False,
                                    label="Minimum Trials (Default: 10)")
    max_trials = forms.IntegerField(initial=100, required=False,
                                    label="Maximum Trials (Default: 100)")
...
class DatasetParams(forms.Form):
    n_trials = forms.IntegerField(label="Number of Trials", initial=None, min_value=1,
                                  max_value=10000, required=False)
